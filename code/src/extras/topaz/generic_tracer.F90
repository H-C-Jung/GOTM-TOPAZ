...
contains
  ...
  subroutine generic_tracer_source(Temp,Salt,rho_dzt,dzt,hblt_depth,ilb,jlb,tau,dtts,&
    ...
    if(do_generic_TOPAZ)  call generic_TOPAZ_update_from_source(tracer_list,Temp,Salt,rho_dzt,dzt,&
         ...
         nbands,max_wavelength_band,sw_pen_band,opacity_band,rad)
...
!    if(do_generic_TOPAZ) &                                                         !hcjung 20180316
!         call generic_TOPAZ_set_boundary_values(tracer_list,ST,SS,rho,ilb,jlb,tau) !hcjung 20180316
