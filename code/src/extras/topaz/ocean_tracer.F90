...
!              call restore_state(Tracer_restart(l), id_tracer_restart(n)) !!hcjung 20170706 for column domain init
...
!    call mpp_update_domains(T_prog(n)%field(:,:,:,tau), Dom%domain2d) !hcjung 20170706 for column domain init
...
!           call restore_state(Tracer_restart(l), id_restart) !hcjung 20170706 for column domain init
...
!        call mpp_update_domains(T_diag(n)%field(:,:,:), Dom%domain2d) !hcjung 20170706 for column domain init
